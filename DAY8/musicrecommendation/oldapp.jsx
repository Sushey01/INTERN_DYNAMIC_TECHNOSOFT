...
const initialFriends = [
  {
    ...
    recBalance: 5,
    recommendations: [
      { id: "song1", title: "Perfect", artist: "Ed Sheeran", suggestedBy: "Kushal" },
      { id: "song2", title: "Gajalu Ti thula", artist: "Narayan Gopal", suggestedBy: "Kushal" },
    ],
  },
  {
    id: 2,
    ...
    recBalance: 10,
    recommendations: [
      { id: "song3", title: "National Anthem", artist: "Kavi Pradeep", suggestedBy: "Sandip" },
      { id: "song4", title: "Tum Hi Ho", artist: "Arjit Singh", suggestedBy: "Sandip" },
    ],
  },
  {
    id: 3,
    ...
    recBalance: -3,
    recommendations: [
      { id: "song5", title: "Hawa Jastai Malai", artist: "John Chamling", suggestedBy: "Susan" },
      { id: "song6", title: "Pratigya le", artist: "Adrian Dewan", suggestedBy: "Susan" },
    ],
  },
  {
    id: 4,
    ...
    recBalance: 0,
    recommendations: [
      { id: "song7", title: "Tum Hi Ho", artist: "Arijit Singh", suggestedBy: "Ashish" },
      { id: "song8", title: "k garu", artist: "John Chamling", suggestedBy: "Ashish" },
    ],
  },
];
...
function Friend({friend , onSelection, selectedFriend}) {
  ...
  const recommendSong = () => {
    if (friend.recommendations && friend.recommendations.length > 0) {
      ...
      const selectedSong = friend.recommendations[randomIndex];
      alert(`Suggested song by ${selectedSong.suggestedBy}: "${selectedSong.title}" by ${selectedSong.artist}`);
    } else {
